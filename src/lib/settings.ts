...
export const SETTINGS_INDEX: SettingsEntry[] = [
  ...
  },
  {
    ...
    keywords: "custom sound file audio ogg wav mp3 som personalizado arquivo turno finished done",
  },
  {
    id: "sounds-inboxUnseen",
    section: "notifications",
    label: "settings.general.sounds.cue.inboxUnseen",
    keywords: "custom sound file audio ogg wav mp3 som personalizado arquivo inbox activity atividade caixa entrada",
  },
  {
    id: "sounds-linkedActivity",
    section: "notifications",
    label: "settings.general.sounds.cue.linkedActivity",
    keywords: "custom sound file audio ogg wav mp3 som personalizado arquivo linked pr issue atividade vinculada",
  },
  {
    id: "sounds-updateAvailable",
    section: "notifications",
    label: "settings.general.sounds.cue.updateAvailable",
    keywords: "custom sound file audio ogg wav mp3 som personalizado arquivo update available atualizacao",
  },
  {
    id: "notifications",
    section: "notifications",
