...
export const MODELS: AgentModel[] = [
  ...
  { id: "opencode:commandcode/big-pickle", harness: "opencode", name: "Big Pickle" },
  { id: "opencode:commandcode/claude-sonnet-5", harness: "opencode", name: "Claude Sonnet 5" },
  {
    id: "opencode:commandcode/claude-sonnet-4-6",
    harness: "opencode",
    name: "Claude Sonnet 4.6",
  },
  { id: "opencode:commandcode/gpt-5.4", harness: "opencode", name: "GPT-5.4" },
  {
    id: "pi:default",
    harness: "pi",
    name: "Default",
...
export const DEFAULT_MODEL_ID: Record<HarnessId, string> = {
  ...
  grok: "grok:grok-4.6",
  opencode: "opencode:commandcode/big-pickle",
  pi: "pi:default",
  omp: "omp:default",
