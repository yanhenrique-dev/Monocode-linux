...
const en = {
  ...
  "shell.menu.terminal": "Terminal",
  "shell.menu.file_menu": "File menu",
  "shell.menu.view_menu": "View menu",
  "shell.menu.terminal_menu": "Terminal menu",
  "shell.menu.new_tab": "New Tab",
  "shell.menu.new_terminal": "New Terminal",
  "shell.menu.new_window": "New Window",
  "shell.menu.open_project": "Open Project…",
  "shell.menu.search": "Search…",
  "shell.menu.go_to_file": "Go to File…",
  "shell.menu.command_palette": "Command Palette…",
  "shell.menu.find_in_files": "Find in Files…",
  "shell.menu.close_pane": "Close Pane",
  "shell.menu.close_other_tabs": "Close Other Tabs",
  "shell.menu.close_all_tabs": "Close All Tabs",
  "shell.menu.check_for_updates": "Check for Updates…",
  "shell.menu.toggle_sidebar": "Toggle Sidebar",
  "shell.menu.inbox": "Inbox",
  "shell.menu.notes": "Notes",
  "shell.menu.toggle_terminal": "Toggle Terminal",
  "shell.menu.switch_model": "Switch Model…",
  "shell.menu.toggle_changes": "Toggle Changes",
  "shell.menu.zoom_in": "Zoom In",
  "shell.menu.zoom_out": "Zoom Out",
  "shell.menu.zoom_reset": "Reset Zoom",
  "shell.menu.reload": "Reload",
  "shell.title.new_session": "New session",
  "shell.title.unsaved_changes": "Unsaved changes",
  "shell.title.response_complete": "Response complete",
  "shell.title.close_tab": "Close Tab",
  "shell.title.close_other_tabs": "Close Other Tabs",
  "shell.title.close_right_tabs": "Close Tabs to the Right",
  "shell.title.close_left_tabs": "Close Tabs to the Left",
  "shell.title.close": "Close {headline}",
  "shell.title.no_project": "No project",
  "shell.title.go_to_file": "Go to File",
  "shell.title.back": "Back",
  "shell.title.forward": "Forward",
  "shell.title.tab_actions": "Tab actions for",
  "shell.title.settings": "Settings",
  "shell.title.inbox": "Inbox",
  "shell.title.notes": "Notes",
  "shell.title.toggle_sidebar": "Toggle Sidebar",
  "shell.title.scroll_tabs_left": "Scroll tabs left",
  "shell.title.scroll_tabs_right": "Scroll tabs right",
  "shell.title.development_build": "Development build",
  "shell.title.development": "Development",
  "shell.title.toggle_projects": "Toggle Projects",
  "shell.sessions.count_one": "1 session",
  "shell.sessions.count_many": "{count} sessions",
  "shell.filters.filter_sessions": "Filter sessions",
  "shell.filters.archived": "Archived",
  "shell.filters.status": "Status",
  "shell.filters.working": "Working",
  "shell.filters.needs_approval": "Needs approval",
  "shell.filters.done": "Done",
  "shell.filters.time": "Time",
  "shell.filters.all_time": "All time",
  "shell.filters.today": "Today",
  "shell.filters.last_7_days": "Last 7 days",
  "shell.filters.last_30_days": "Last 30 days",
  "shell.filters.provider": "Provider",
  "shell.filters.clear": "Clear filters",
  "shell.usage.terminal": "Terminal",
  "shell.usage.new_terminal": "New Terminal",
  "shell.usage.provider_usage": "Provider usage",
  "shell.usage.terminals": "Terminals",
  "shell.usage.session": "Session",
  "shell.usage.refresh": "Refresh usage",
  "shell.usage.sign_in_required": "{provider} sign-in required",
  "shell.usage.sign_in": "sign in",
  "shell.usage.sign_in_dialog": "{provider} sign-in",
  "shell.usage.running_terminals": "Running terminals",
  "shell.usage.hide_terminal": "Hide {process}",
  "shell.usage.show_terminal": "Show {process}",
  "shell.usage.hide_terminals": "Hide running terminals",
  "shell.usage.terminals_running": "{count} terminals are running processes",
  "shell.usage.codex_reset_error": "Could not use Codex reset",
  "shell.usage.sign_in_unverified": "{provider} sign-in could not be verified",
  "shell.usage.sign_in_error": "Could not complete sign-in",
  "shell.auth.signed_in": "Signed in to {provider}",
  "shell.auth.authentication_required": "Authentication required",
  "shell.auth.retry_last_message": "You can retry your last message now.",
  "shell.auth.sign_in_continue": "Sign in to continue using {provider}.",
  "shell.auth.waiting_browser": "Waiting for browser…",
  "shell.auth.signed_in_button": "Signed in",
  "shell.auth.sign_in_to_provider": "Sign in to {provider}",
  "shell.project.search": "Search",
  "shell.project.inbox": "Inbox",
  "shell.project.inbox_new": "Inbox, new items",
  "shell.project.notes": "Notes",
  "shell.project.pinned": "Pinned",
  "shell.project.groups": "Groups",
  "shell.project.projects": "Projects",
  "shell.project.no_projects": "No projects yet",
  "shell.project.settings": "Settings",
  "shell.project.new_group": "New group…",
  "shell.project.new_project_group": "New project group",
  "shell.project.open_project": "Open project",
  "shell.project.ungrouped": "Ungrouped",
  "shell.project.background_image": "Background image",
  "shell.project.move_to_group": "Move to group",
  "shell.project.unpin": "Unpin project",
  "shell.project.pin": "Pin project",
  "shell.project.open_containing_folder": "Open Containing Folder",
  "shell.project.open_editor": "Open in editor",
  "shell.project.looking_editors": "Looking for editors…",
  "shell.project.no_editors": "No supported editors found",
  "shell.project.mute_notifications": "Mute notifications",
  "shell.project.notification_settings": "Notification settings…",
  "shell.project.archive": "Archive",
  "shell.project.unarchive": "Unarchive",
  "shell.project.delete": "Delete",
  "shell.project.resume_notifications": "Resume notifications",
  "shell.project.project_options": "Project options",
  "shell.project.group_options": "Group options",
  "shell.project.group_options_aria": "group options",
  "shell.project.delete_group": "Delete group",
  "shell.project.projects_ungrouped": "Projects will become ungrouped",
  "shell.project.group_actions": "Project group actions",
  "shell.project.group_count_one": "1 project",
  "shell.project.group_count_many": "{count} projects",
  "shell.project.working": "Working",
  "shell.project.files_changed_one": "1 file changed",
  "shell.project.files_changed_many": "{count} files changed",
  "shell.project.uncommitted": "uncommitted",
  "shell.sidebar.sessions": "Sessions",
  "shell.sidebar.inbox": "Inbox",
  "shell.sidebar.explorer": "Explorer",
  "shell.sidebar.changes": "Changes",
  "shell.sidebar.search_conversations": "Search conversations...",
  "shell.sidebar.no_project_folder": "No project folder",
  "shell.sidebar.load_sessions_error": "Couldn’t load sessions",
  "shell.sidebar.no_matching_sessions": "No matching sessions",
  "shell.sidebar.sessions_start_hint": "Sessions you start will show up here",
  "shell.sidebar.no_sessions_match_filters": "No sessions match these filters",
  "shell.sidebar.workspace": "Workspace",
  "shell.sidebar.filter_sessions": "Filter sessions",
  "shell.sidebar.reminders": "Reminders",
  "shell.sidebar.pinned": "Pinned",
  "shell.sidebar.rename": "Rename",
  "shell.sidebar.ungroup": "Ungroup",
  "shell.sidebar.cancel_reminder": "Cancel reminder",
  "shell.sidebar.multiple_reminder_times": "Multiple reminder times",
  "shell.sidebar.unpin": "Unpin",
  "shell.sidebar.pin": "Pin",
  "shell.sidebar.remind_me": "Remind me",
  "shell.reminder.one_hour": "In 1 hour ({time})",
  "shell.reminder.three_hours": "In 3 hours ({time})",
  "shell.reminder.evening": "This evening (18:00)",
  "shell.reminder.tomorrow": "Tomorrow (9:00)",
  "shell.reminder.next_week": "Next week (Mon 9:00)",
  "shell.sidebar.new_folder": "New folder",
  "shell.sidebar.add_to": "Add to {folder}",
  "shell.sidebar.remove_from_folders": "Remove from folders",
  "shell.sidebar.remove_from_folder": "Remove from folder",
  "shell.sidebar.delete": "Delete",
  "shell.sidebar.new_session": "New session",
  "shell.sidebar.resize": "Resize sidebar",
  "shell.sidebar.folder_actions": "Folder actions",
  "shell.sidebar.session_actions": "Session actions",
  "shell.sidebar.selected_session_actions": "{count} selected session actions",
  "shell.sidebar.status.needs_input": "Needs input",
  "shell.sidebar.status.needs_approval": "Need approval",
  "shell.sidebar.status.working": "Working...",
  "shell.sidebar.status.done": "Done",
  "shell.sidebar.linked_updated": "Linked {kind} updated since this session",
  "shell.sidebar.linked_work_item_updated": "Linked work item updated",
  "shell.sidebar.open_linked": "Open {kind} #{number} beside this session",
  "shell.sidebar.open_linked_aria": "Open {kind} #{number}",
  "shell.sidebar.orchestrator": "Orchestrator, {count} subagents, {done} done",
  "shell.sidebar.subagents": "Subagents",
  "shell.sidebar.subagents_progress": "{done}/{total} done",
  "shell.search.back_files": "Back to files",
  "shell.search.in_files": "Search in files",
  "shell.search.search": "Search",
  "shell.search.match_case": "Match case",
  "shell.search.match_whole_word": "Match whole word",
  "shell.search.regular_expression": "Use regular expression",
  "shell.search.include_files": "files to include",
  "shell.search.exclude_files": "files to exclude",
  "shell.search.searching": "Searching…",
  "shell.search.no_results": "No results",
  "shell.search.results_one": "1 result in 1 file",
  "shell.search.results_one_many_files": "1 result in {files} files",
  "shell.search.results_many_one_file": "{count} results in 1 file",
  "shell.search.results_many": "{count} results in {files} files",
  "shell.search.limited": " (limited)",
  "shell.search.type_to_search": "Type to search across the project",
  ...
  "settings.general.notifications.open_system_settings": "Open System Settings",
  ...
  "settings.general.update.flatpak": "Updates are managed by Flatpak.",
  ...
  "settings.worktrees.refresh_failed":
    "Refresh failed: {error}. Click to retry.",
  ...
  "settings.worktrees.sessions_using_one":
    "{count} session using this worktree is",
  "settings.worktrees.sessions_using_other":
    "{count} sessions using this worktree are",
  ...
  "settings.worktrees.sessions_kept":
  ...
  "settings.worktrees.unpushed_kept":
  ...
  "settings.appearance.pets.pixel_aria":
    "Pixel row {row} column {column} {state}",
  ...
  "settings.keybindings.cmd.composer_toggle_workspace":
  ...
  "settings.providers.row.models_available_other": "{count} models available.",
  ...
  "settings.skills.form.create_hint": "Create a starter SKILL.md you can edit",
  ...
  "settings.inbox.project_notifications.category_for": "{category} for {name}",
  "settings.inbox.project_notifications.local": "Local project · ",
  "settings.inbox.project_notifications.all_paused": "All notifications paused",
  "settings.inbox.project_notifications.all_enabled": "All categories enabled",
...
const ptBR: Record<LocaleKey, string> = {
  "shell.menu.file": "Arquivo",
  "shell.menu.view": "Exibir",
  "shell.menu.terminal": "Terminal",
  "shell.menu.file_menu": "Menu Arquivo",
  "shell.menu.view_menu": "Menu Exibir",
  "shell.menu.terminal_menu": "Menu Terminal",
  "shell.menu.new_tab": "Nova aba",
  "shell.menu.new_terminal": "Novo terminal",
  "shell.menu.new_window": "Nova janela",
  "shell.menu.open_project": "Abrir projeto…",
  "shell.menu.search": "Pesquisar…",
  "shell.menu.go_to_file": "Ir para arquivo…",
  "shell.menu.command_palette": "Paleta de comandos…",
  "shell.menu.find_in_files": "Localizar nos arquivos…",
  "shell.menu.close_pane": "Fechar painel",
  "shell.menu.close_other_tabs": "Fechar outras abas",
  "shell.menu.close_all_tabs": "Fechar todas as abas",
  "shell.menu.check_for_updates": "Verificar atualizações…",
  "shell.menu.toggle_sidebar": "Alternar barra lateral",
  "shell.menu.inbox": "Caixa de entrada",
  "shell.menu.notes": "Notas",
  "shell.menu.toggle_terminal": "Alternar terminal",
  "shell.menu.switch_model": "Trocar modelo…",
  "shell.menu.toggle_changes": "Alternar alterações",
  "shell.menu.zoom_in": "Aumentar zoom",
  "shell.menu.zoom_out": "Diminuir zoom",
  "shell.menu.zoom_reset": "Redefinir zoom",
  "shell.menu.reload": "Recarregar",
  "shell.title.new_session": "Nova sessão",
  "shell.title.unsaved_changes": "Alterações não salvas",
  "shell.title.response_complete": "Resposta concluída",
  "shell.title.close_tab": "Fechar aba",
  "shell.title.close_other_tabs": "Fechar outras abas",
  "shell.title.close_right_tabs": "Fechar abas à direita",
  "shell.title.close_left_tabs": "Fechar abas à esquerda",
  "shell.title.close": "Fechar {headline}",
  "shell.title.no_project": "Sem projeto",
  "shell.title.go_to_file": "Ir para arquivo",
  "shell.title.back": "Voltar",
  "shell.title.forward": "Avançar",
  "shell.title.tab_actions": "Ações da aba para",
  "shell.title.settings": "Configurações",
  "shell.title.inbox": "Caixa de entrada",
  "shell.title.notes": "Notas",
  "shell.title.toggle_sidebar": "Alternar barra lateral",
  "shell.title.scroll_tabs_left": "Rolar abas para a esquerda",
  "shell.title.scroll_tabs_right": "Rolar abas para a direita",
  "shell.title.development_build": "Versão de desenvolvimento",
  "shell.title.development": "Desenvolvimento",
  "shell.title.toggle_projects": "Alternar projetos",
  "shell.sessions.count_one": "1 sessão",
  "shell.sessions.count_many": "{count} sessões",
  "shell.filters.filter_sessions": "Filtrar sessões",
  "shell.filters.archived": "Arquivadas",
  "shell.filters.status": "Status",
  "shell.filters.working": "Trabalhando",
  "shell.filters.needs_approval": "Requer aprovação",
  "shell.filters.done": "Concluídas",
  "shell.filters.time": "Tempo",
  "shell.filters.all_time": "Todo o período",
  "shell.filters.today": "Hoje",
  "shell.filters.last_7_days": "Últimos 7 dias",
  "shell.filters.last_30_days": "Últimos 30 dias",
  "shell.filters.provider": "Provedor",
  "shell.filters.clear": "Limpar filtros",
  "shell.usage.terminal": "Terminal",
  "shell.usage.new_terminal": "Novo terminal",
  "shell.usage.provider_usage": "Uso dos provedores",
  "shell.usage.terminals": "Terminais",
  "shell.usage.session": "Sessão",
  "shell.usage.refresh": "Atualizar uso",
  "shell.usage.sign_in_required": "Login em {provider} necessário",
  "shell.usage.sign_in": "Entrar",
  "shell.usage.sign_in_dialog": "Login em {provider}",
  "shell.usage.running_terminals": "Terminais em execução",
  "shell.usage.hide_terminal": "Ocultar {process}",
  "shell.usage.show_terminal": "Mostrar {process}",
  "shell.usage.hide_terminals": "Ocultar terminais em execução",
  "shell.usage.terminals_running":
    "{count} terminais estão executando processos",
  "shell.usage.codex_reset_error":
    "Não foi possível usar a reinicialização do Codex",
  "shell.usage.sign_in_unverified":
    "Não foi possível verificar o login em {provider}",
  "shell.usage.sign_in_error": "Não foi possível concluir o login",
  "shell.auth.signed_in": "Login efetuado em {provider}",
  "shell.auth.authentication_required": "Autenticação necessária",
  "shell.auth.retry_last_message":
    "Agora você pode tentar novamente sua última mensagem.",
  "shell.auth.sign_in_continue": "Entre para continuar usando {provider}.",
  "shell.auth.waiting_browser": "Aguardando navegador…",
  "shell.auth.signed_in_button": "Login efetuado",
  "shell.auth.sign_in_to_provider": "Entrar em {provider}",
  "shell.project.search": "Pesquisar",
  "shell.project.inbox": "Caixa de entrada",
  "shell.project.inbox_new": "Caixa de entrada, novos itens",
  "shell.project.notes": "Notas",
  "shell.project.pinned": "Fixados",
  "shell.project.groups": "Grupos",
  "shell.project.projects": "Projetos",
  "shell.project.no_projects": "Nenhum projeto ainda",
  "shell.project.settings": "Configurações",
  "shell.project.new_group": "Novo grupo…",
  "shell.project.new_project_group": "Novo grupo de projetos",
  "shell.project.open_project": "Abrir projeto",
  "shell.project.ungrouped": "Sem grupo",
  "shell.project.background_image": "Imagem de fundo",
  "shell.project.move_to_group": "Mover para grupo",
  "shell.project.unpin": "Desafixar projeto",
  "shell.project.pin": "Fixar projeto",
  "shell.project.open_containing_folder": "Abrir pasta do projeto",
  "shell.project.open_editor": "Abrir no editor",
  "shell.project.looking_editors": "Procurando editores…",
  "shell.project.no_editors": "Nenhum editor compatível encontrado",
  "shell.project.mute_notifications": "Silenciar notificações",
  "shell.project.notification_settings": "Configurações de notificações…",
  "shell.project.archive": "Arquivar",
  "shell.project.unarchive": "Desarquivar",
  "shell.project.delete": "Excluir",
  "shell.project.resume_notifications": "Retomar notificações",
  "shell.project.project_options": "Opções do projeto",
  "shell.project.group_options": "Opções do grupo",
  "shell.project.group_options_aria": "opções do grupo",
  "shell.project.delete_group": "Excluir grupo",
  "shell.project.projects_ungrouped": "Projetos ficarão sem grupo",
  "shell.project.group_actions": "Ações do grupo de projetos",
  "shell.project.group_count_one": "1 projeto",
  "shell.project.group_count_many": "{count} projetos",
  "shell.project.working": "Trabalhando",
  "shell.project.files_changed_one": "1 arquivo alterado",
  "shell.project.files_changed_many": "{count} arquivos alterados",
  "shell.project.uncommitted": "não commitado",
  "shell.sidebar.sessions": "Sessões",
  "shell.sidebar.inbox": "Caixa de entrada",
  "shell.sidebar.explorer": "Explorador",
  "shell.sidebar.changes": "Alterações",
  "shell.sidebar.search_conversations": "Pesquisar conversas...",
  "shell.sidebar.no_project_folder": "Nenhuma pasta de projeto",
  "shell.sidebar.load_sessions_error": "Não foi possível carregar sessões",
  "shell.sidebar.no_matching_sessions": "Nenhuma sessão correspondente",
  "shell.sidebar.sessions_start_hint": "Sessões iniciadas aparecerão aqui",
  "shell.sidebar.no_sessions_match_filters":
    "Nenhuma sessão corresponde aos filtros",
  "shell.sidebar.workspace": "Espaço de trabalho",
  "shell.sidebar.filter_sessions": "Filtrar sessões",
  "shell.sidebar.reminders": "Lembretes",
  "shell.sidebar.pinned": "Fixadas",
  "shell.sidebar.rename": "Renomear",
  "shell.sidebar.ungroup": "Desagrupar",
  "shell.sidebar.cancel_reminder": "Cancelar lembrete",
  "shell.sidebar.multiple_reminder_times": "Vários horários de lembrete",
  "shell.sidebar.unpin": "Desafixar",
  "shell.sidebar.pin": "Fixar",
  "shell.sidebar.remind_me": "Lembrar-me",
  "shell.reminder.one_hour": "Em 1 hora ({time})",
  "shell.reminder.three_hours": "Em 3 horas ({time})",
  "shell.reminder.evening": "Esta noite (18:00)",
  "shell.reminder.tomorrow": "Amanhã (9:00)",
  "shell.reminder.next_week": "Semana que vem (seg. 9:00)",
  "shell.sidebar.new_folder": "Nova pasta",
  "shell.sidebar.add_to": "Adicionar a {folder}",
  "shell.sidebar.remove_from_folders": "Remover das pastas",
  "shell.sidebar.remove_from_folder": "Remover da pasta",
  "shell.sidebar.delete": "Excluir",
  "shell.sidebar.new_session": "Nova sessão",
  "shell.sidebar.resize": "Redimensionar barra lateral",
  "shell.sidebar.folder_actions": "Ações da pasta",
  "shell.sidebar.session_actions": "Ações da sessão",
  "shell.sidebar.selected_session_actions":
    "Ações de {count} sessões selecionadas",
  "shell.sidebar.status.needs_input": "Requer entrada",
  "shell.sidebar.status.needs_approval": "Requer aprovação",
  "shell.sidebar.status.working": "Trabalhando...",
  "shell.sidebar.status.done": "Concluída",
  "shell.sidebar.linked_updated":
    "{kind} vinculada atualizada desde esta sessão",
  "shell.sidebar.linked_work_item_updated":
    "Item de trabalho vinculado atualizado",
  "shell.sidebar.open_linked": "Abrir {kind} #{number} ao lado desta sessão",
  "shell.sidebar.open_linked_aria": "Abrir {kind} #{number}",

  "shell.sidebar.orchestrator":
    "Orquestrador, {count} subagentes, {done} concluídos",
  "shell.sidebar.subagents": "Subagentes",
  "shell.sidebar.subagents_progress": "{done}/{total} concluídos",
  "shell.search.back_files": "Voltar aos arquivos",
  "shell.search.in_files": "Pesquisar nos arquivos",
  "shell.search.search": "Pesquisar",
  "shell.search.match_case": "Diferenciar maiúsculas de minúsculas",
  "shell.search.match_whole_word": "Corresponder palavra inteira",
  "shell.search.regular_expression": "Usar expressão regular",
  "shell.search.include_files": "arquivos para incluir",
  "shell.search.exclude_files": "arquivos para excluir",
  "shell.search.searching": "Pesquisando…",
  "shell.search.no_results": "Nenhum resultado",
  "shell.search.results_one": "1 resultado em 1 arquivo",
  "shell.search.results_one_many_files": "1 resultado em {files} arquivos",
  "shell.search.results_many_one_file": "{count} resultados em 1 arquivo",
  "shell.search.results_many": "{count} resultados em {files} arquivos",
  "shell.search.limited": " (limitado)",
  "shell.search.type_to_search": "Digite para pesquisar no projeto",
  ...
  "settings.general.sounds.cue.linkedActivity":
    "Atividade em PR/issue vinculado",
  ...
  "settings.general.sounds.error.missing":
  ...
  "settings.general.update.flatpak": "Atualizações gerenciadas pelo Flatpak.",
  ...
  "updater.dialog.check_failed":
    "Não foi possível verificar atualizações.\n\n{error}",
  "updater.dialog.install_failed":
  ...
  "settings.worktrees.refresh_failed":
    "Falha ao atualizar: {error}. Clique para tentar de novo.",
  "settings.worktrees.add_project":
    "Adicione um projeto para gerenciar seus worktrees.",
  ...
  "settings.worktrees.sessions_using_other":
    "{count} sessões neste worktree estão",
  ...
  "settings.worktrees.unpushed_one":
    "{count} commit não está em um remoto. Ele permanece no branch.",
  "settings.worktrees.unpushed_other":
    "{count} commits não estão em um remoto. Eles permanecem no branch.",
  "settings.worktrees.unpushed_one_short": "{count} commit",
  "settings.worktrees.unpushed_other_short": "{count} commits",
  ...
  "settings.worktrees.sessions_kept":
    "mantidas. Selecione um branch ou worktree para continuar.",
  ...
  "settings.worktrees.unpushed_kept":
    "não estão em um remoto. Eles ficam no branch.",
  "settings.worktrees.delete_sessions_label":
    "Excluir também as sessões associadas",
  ...
  "settings.appearance.pets.pixel_aria":
    "Pixel linha {row} coluna {column} {state}",
  ...
  "settings.appearance.pets.saved":
    "Salvo — escolha em qualquer menu de projeto.",
  "settings.appearance.pets.error_invalid":
  ...
  "settings.appearance.chat_background.remove_title": "Remover fundo do chat?",
  "settings.appearance.chat_background.remove_description":
  ...
  "settings.keybindings.cmd.view_toggle_fullscreen":
    "Exibir: Alternar tela cheia",
  ...
  "settings.skills.form.hint":
    "Escreve um SKILL.md inicial que você pode editar.",
  "settings.skills.form.name_label": "Nome da skill",
  "settings.skills.form.name_hint": "Use letras minúsculas, números e hifens.",
  ...
  "settings.archive.show_archived.toggle":
    "Mostrar arquivados na barra lateral",
  "settings.archive.sessions.empty_no_project":
  ...
  "settings.sessions.delete.worktree":
    "Excluir também o worktree não utilizado",
  "settings.sessions.delete.worktree_note":
  ...
  "settings.inbox.project_notifications.select_projects": "Selecionar projetos",
  ...
  "settings.inbox.project_notifications.category_for": "{category} para {name}",
