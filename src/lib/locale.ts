...
const en = {
  ...
  "welcome.github.rate_limited": "GitHub API rate limit active. Retry in {seconds}s.",
  "welcome.github.rate_limited_unknown": "GitHub API rate limit active. Try again later.",
  ...
  "welcome.github.optional": "You can use MonoCode without GitHub. Connect it later in Settings.",
  ...
  "welcome.providers.checklist_settings": "Providers can be changed later in Settings.",
...
const ptBR: Record<LocaleKey, string> = {
  ...
  "welcome.version.body": "O MonoCode está pronto para abrir seu espaço de trabalho.",
  "welcome.version.current": "Versão atual",
  "welcome.version.release_notes": "Notas da versão: {title}",
  "welcome.version.flatpak": "O Flatpak gerencia as atualizações desta instalação.",
  ...
  "welcome.github.title": "GitHub CLI",
  "welcome.github.body": "Conecte o GitHub para usar itens da Inbox e pull requests.",
  ...
  "welcome.github.rate_limited": "Limite da API do GitHub ativo. Tente novamente em {seconds}s.",
  "welcome.github.rate_limited_unknown": "Limite da API do GitHub ativo. Tente novamente mais tarde.",
  ...
  "welcome.github.optional": "Você pode usar o MonoCode sem GitHub. Conecte depois em Configurações.",
  ...
  "welcome.providers.checklist_cli": "Pelo menos uma CLI de agente está pronta.",
  "welcome.providers.checklist_github": "O acesso ao GitHub é opcional.",
  "welcome.providers.checklist_settings": "Provedores podem ser alterados depois em Configurações.",
  ...
  "welcome.errors.load": "Não foi possível carregar os detalhes da configuração.",
