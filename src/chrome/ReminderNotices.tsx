  ...
  return createPortal(
    <>
      <section
        ...
        className="fixed top-3 right-3 w-[min(320px,calc(100vw-24px))] overflow-hidden rounded-xl border border-content/15 bg-background-base/95 text-content shadow-xl glass-blur backdrop-blur-md"
      >
