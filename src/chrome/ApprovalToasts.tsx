...
function ApprovalToastCard({
  ...
  return (
    <article
      className="approval-toast pointer-events-auto overflow-hidden rounded-xl border border-content/20 border-dashed bg-content/10 shadow-xl glass-blur backdrop-blur-xl"
      role="status"
    >
      <button
        type="button"
